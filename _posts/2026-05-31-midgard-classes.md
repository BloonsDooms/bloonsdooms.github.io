---
title: Midgard Classes
date: 2026-05-31 10:00:00 +8000
categories: [Midgard Classes]
tags: [getting-started, leveling]     # TAG names should always be lowercase
description: A short guide on all the available classes to the realm of Midgard.
toc: true
comments: false
---
...
## Thane
Hybrid caster and shield tank. Weaker spells than pure casters, lower damage than pure melee, access to chainmail armor.

Again, your weapons of choice include Axes, Hammers, and Swords. But you also get a medium shield, and one you can specialize into for benefits.
Your spells include area of effect damage, single target damage, self buffs, and a few instant cast emergency spells.
Because you have a medium shield, you can defend and block attacks for other party members. The class is also very fun to play, but can be a bit difficult to juggle.

## Warrior
Pure shield tank, with access to chainmail armor and a large shield.
...
You have the choice between a sword and a spear, as well as your bow. You also get a special pet dog, which can chase down stealthed enemies.

## Shadowblade
Leather armor, special critical strikes, and stealth.

A choice between Axes and Swords, you also can dual wield a Left Axe.
Your special critical strikes can do massive damage, which tends to make you a glass cannon.
